...
int main(){
    ...
    while(iterator == -1){
        if(questionCountDrink == -1){
            cout << "The catinator greets you joyfully.  With a soft 'meow'" << endl;
        ...
        if(questionCountDrink == 0){
            cout << "Are you hungry?  Or are you thirsty?" << endl;
            cout << "A: hungry" << endl;
            cout << "B: Thirsty" << endl;
            cin >> choice;
        ...
        if(questionCountDrink == 1){
            cout << "Would you like it to be sweet?" << endl;
            cout << "A: Yes" << endl;
            cout << "B: No" << endl;
            cin >> choice;
        ...
        if(questionCountDrink == 2){
            cout << "Would you like it to be hot?" << endl;
            cout << "A: Yes" << endl;
            cout << "B: No" << endl;
            cin >> choice;
        ...
        if(questionCountFood == 3 && foodOrDrink == false){
            cout << "Would you like it to be spicy?" << endl;
            cout << "A: Yes" << endl;
            cout << "B: No" << endl;
            cin >> choice;
        ...
        if(questionCountFood == 4 && foodOrDrink == false){
            cout << "Would you like it to be vegetarian?" << endl;
            cout << "A: Yes" << endl;
            cout << "B: No" << endl;
            cin >> choice;
        ...
        if(questionCountDrink == 3 && foodOrDrink == true){
            cout << "Would you like it to be caffeinated?" << endl;
            cout << "A: Yes" << endl;
            cout << "B: No" << endl;
            cin >> choice;
        ...
        if(questionCountFood == 5 && foodOrDrink == false){
            ...
            cout << reccomendedItem.getItemName() << ": " << reccomendedItemURL << endl;
            questionCountFood++;
        }
